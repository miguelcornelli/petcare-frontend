...
import { Home, Dog, Syringe, AlertTriangle, MoreHorizontal, X, FlaskConical, Bug, Stethoscope, Shield, UserCircle } from 'lucide-react'
...
export function BottomNav() {
  ...
  return (
    <>
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      active ? 'bg-emerald-50 text-emerald-600' : 'bg-gray-50 text-gray-600 hover:bg-gray-100'
                    )}
                  >
      ...
      {/* Bottom nav bar */}
      <nav
        className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-100 lg:hidden bottom-nav-safe"
      ...
      >
        <div className="flex items-stretch h-16">
          ...
          >
            <span className={cn(
              'flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-2xl transition-all',
              (moreActive || showMore) ? 'bg-emerald-50' : ''
            )}>

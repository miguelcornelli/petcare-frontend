  ...
  ({ label, error, dark, className, id, ...props }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-1">
        {label && (
          <label htmlFor={inputId} className={cn('text-sm font-medium', dark ? 'text-black' : 'text-gray-700')}>
            {label}
          </label>
        )}
        <input
          ...
          className={cn(
            ...
            dark
              ? 'bg-white border-gray-300 text-black placeholder-gray-400 focus:ring-emerald-400'
              : error
